  ...
  <main className="articles">
   <header>
    <div className="column">
     <h1>Articles <br /> by <strong>Craig Claybrook</strong></h1>
    </div>
   </header>
   <section>
    <img src="https://thomasjeffersonrecites.s3.amazonaws.com/headshot-2.webp" alt="Craig Claybrook as Thomas Jefferson" width="300" />
    <h2>Launching the Declaration of Independence onto the National Stage</h2>
    <h3>By Craig L. Claybrook, Reciter of the Declaration</h3>
    <p>For decades and decades, Americans enthusiastically read <em>The Declaration of Independence</em> in the public
    ...
    <p>Consider this reasoning: 1. the significance and impact of the document, 2. the “Foundational
    ...
    <p><strong>First, the significance and impact of the document.</strong>Church historians tell us that the Declaration is “one
    ...
    <p>The other document happens to be The Constitution of the United States. It took 116 days for the
    ...
    copies of the document to all of those countries. They thought the Constitution was magnificent so, they
    ...
    beginnings.</p>
    <p><strong>Second, the “Foundational Underpinnings” of the document.</strong>Secular historians tell us that the pathway
    to <em>The Declaration of Independence</em> began when the British attacked Lexington, Massachusetts “at dawn
    ...
    continue to this day. Politically, he became known for his Resistance Theory: to disobey unjust rulers
    and their laws.”</p>
    <p>Why were these events so vitally important? Pope Gregory VII started the march to America’s freedom
    ...
    Middle Ages, “limiting the power of kings.” Martin Luther’s theses caused the pope to put him on trial
    for heresy. When he argued that “it was wrong for anyone to act against his conscience in religious
    matters,” he set off a firestorm that became known as “liberty of conscience.” These three “episodes” in
    our Foundational Underpinnings paved the way for the Declaration.</p>
    <p><strong>Third, the deliberate demise of the document’s “worth.”</strong>The demise of the Declaration started out,
    ...
    parochial schools. An amicus brief from an atheistic organization introduced the Court to “wall of
    ...
    <p>This unprincipled decision lay dormant until the 1963 Supreme Court dredged it up when considering
    <em>Murray v. Curlett</em>, a case filed by atheist Madalyn Murray O’Hair to ban Bible reading in public schools.
    ...
    <p>How does the Declaration fit into this? Quite simply, the Declaration contains four references to God.
    ...
    themselves to deliver the “crowning blow” to <em>The Declaration of Independence</em> and America’s
    ...
    1947 was awarded as “The Most Influential Supreme Court Justice of the Twentieth Century!”</p>
    <p><strong>Fourth, the overwhelming need for a triumphal return of the document.</strong>These four references to God
    provide the key element to “launching the Declaration onto the national stage.” They stand in sharp
    ...
    <p>As for the “demise of worth,” a plethora of people and organizations would favor restoring its worth if
    presented with the need!” We are an army lacking vision so, focus on: 1. grasping the magnitude of “the
    ...
    <p>These four references to God serve as a catalyst for “launching the Declaration onto the national stage.”
    They also serve as a catalyst for spiritual awakening.” They go “hand in hand.” And, if you are so
    inclined, please pass the “snippet” of the Declaration along to three or more friends via the Internet.
    Thank you for your help in “launching” the Declaration with your prayers, concern, and effort!</p>
   </section>
  </main>
 )
}
